...
database_name = case Padrino.env
  when :development then 'wovote_development'
  when :production  then 'wovote_production'
  when :test        then 'wovote_test'
end
...
#     sessions:
#       default:
#         database: wovote_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: wovote_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: wovote_test
#         hosts:
#           - localhost:27017
#
#
